...
class ActivitySummary {
  const ActivitySummary({required this.steps, required this.distanceKm, required this.activeCalories});
  final int steps;
...
class LocalActivityService implements ActivityService {
  ...
  @override
  Future<ActivitySummary> loadToday() async => const ActivitySummary(
    steps: 0,
    distanceKm: 0,
    activeCalories: 0,
  );
